...
{
    typedef typename ::bx::remove_cv<typename
     ::bx::remove_reference<T>::type>::type  type;

};  // bx::detail::remove_cv_ref
...
struct is_related
    : public ::bx::is_same<
     typename ::bx::detail::remove_cv_ref<T>::type,
     typename ::bx::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::bx::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::bx::disable_if< ::bx::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::bx::detail::enable_if_unrelated<base_from_member, T...>::type>
