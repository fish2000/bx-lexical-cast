...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::bx::mpl::aux::yes_tag operator|( \
      ::bx::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::bx::mpl::aux::no_tag operator|( \
      ::bx::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::bx::mpl::na) >* \
    ); \
/**/
...
::bx::mpl::aux::yes_tag operator|( \
      ::bx::mpl::aux::has_rebind_tag<int> \
    , ::bx::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
