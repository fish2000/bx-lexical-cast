...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the bx::adaptors::filtered
        // class with a bx::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                bx::ignore_unused_variable_warning(i2);
                ...
                bx::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                bx::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = bx::begin(*m_range);
            iterator i2 = bx::end(*m_range);

            bx::ignore_unused_variable_warning(i1);
            bx::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = bx::begin(const_range);
            const_iterator ci2 = bx::end(const_range);

            bx::ignore_unused_variable_warning(ci1);
            bx::ignore_unused_variable_warning(ci2);
        }
