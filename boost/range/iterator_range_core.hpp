...
namespace bx
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( bx::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( bx::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( bx::begin(l),
                                                 bx::end(l),
                                                 bx::begin(r),
                                                 bx::end(r) );
        }
...
incrementable_t test_traversal_tag(bx::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(bx::bidirectional_traversal_tag);
random_access_t test_traversal_tag(bx::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef bx::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef bx::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef bx::random_access_traversal_tag type;
};
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                bx::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::bx::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME bx::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME bx::enable_if<
            mpl::not_<bx::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, bx::next(first, n));
        }
        ...
        */
        ...
        {
            return SeqT( bx::begin( r ), bx::end( r ) );
        }
