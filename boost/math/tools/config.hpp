...
#include <boost/cstdint.hpp> // for bx::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         bx::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    bx::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  bx::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  bx::non_type<t, v>*
...
#  define BOOST_MATH_NOEXCEPT(T) noexcept(bx::is_floating_point<T>::value)
#  define BOOST_MATH_IS_FLOAT(T) (bx::is_floating_point<T>::value)
#endif
#else
...
{
   static const bool value = bx::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#    define BOOST_FPU_EXCEPTION_GUARD bx::math::detail::fpu_guard local_guard_object;
