...
#else
     typedef bx::uintmax_t static_min_max_unsigned_type;
     typedef bx::intmax_t  static_min_max_signed_type;
     typedef bx::uintmax_t static_log2_argument_type;
     typedef int              static_log2_result_type;
#endif
...
#if !defined(BOOST_NO_INTEGRAL_INT64_T) && defined(BOOST_HAS_LONG_LONG)
  template< bx::ulong_long_type MaxValue >   // maximum value to require support
#else
...
#else
     typedef bx::uintmax_t static_gcd_type;
#endif
