...
{
   BOOST_STATIC_CONSTANT(bool, value = (::bx::detail::is_unsigned_values<T>::minus_one > ::bx::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::bx::detail::is_unsigned_select_helper< ::bx::is_integral<T>::value || ::bx::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, bx::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::bx::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::bx::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::bx::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::bx::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::bx::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::bx::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::bx::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::bx::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
