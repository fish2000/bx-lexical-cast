...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::bx::detail::is_signed_values<T>::minus_one  > bx::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::bx::detail::is_signed_select_helper< ::bx::is_integral<T>::value || ::bx::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, bx::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::bx::long_long_type> : public true_type{};
template <> struct is_signed<const ::bx::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::bx::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::bx::long_long_type> : public true_type{};

template <> struct is_signed< ::bx::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::bx::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::bx::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::bx::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
