...
{
   typedef is_polymorphic_selector< ::bx::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::bx::detail::is_polymorphic_imp<T>::value> {};
