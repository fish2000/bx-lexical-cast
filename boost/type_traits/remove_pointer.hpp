...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename bx::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::bx::is_pointer<T>::value>::type type;
   };
}

template <class T> struct remove_pointer{ typedef typename bx::detail::remove_pointer_imp2<T>::type type; };
