...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::bx::is_class<B>::value,
       ::bx::is_class<D>::value,
       ::bx::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::bx::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::bx::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
