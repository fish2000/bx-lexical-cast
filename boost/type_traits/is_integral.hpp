...
template<> struct is_integral< ::bx::ulong_long_type> : public true_type{};
template<> struct is_integral< ::bx::long_long_type> : public true_type{};
...
template<> struct is_integral<bx::int128_type> : public true_type{};
template<> struct is_integral<bx::uint128_type> : public true_type{};
#endif
